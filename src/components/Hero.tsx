...
const Hero = () => {
  ...
  return <section className="relative min-h-[500px] sm:min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden pt-20 xs:pt-22 md:pt-24 lg:pt-28">
      {/* Background Image with Modern Overlay */}
      <div className="absolute inset-0 z-0">
        <img src={heroImage} alt="Villas modernes au Sénégal - Gestion locative professionnelle" className="w-full h-full object-cover object-[center_40%] sm:object-center" />
      ...
      <div className="container mx-auto px-2 xs:px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-fade-in-up flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 xs:gap-4">
              <div className="sm:col-span-1">
                {isMobile ? <div className="relative">
                    ...
                    <select value={propertyType} onChange={e => setPropertyType(e.target.value)} className="w-full bg-white/90 border border-white/30 h-11 xs:h-12 rounded-xl text-sm xs:text-base pl-10 pr-3 appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary" style={{
                  ...
                  </div> : <Select value={propertyType} onValueChange={setPropertyType}>
              ...
              <div className="sm:col-span-1">
                <div className="relative">
                  ...
                  <Input placeholder="Ville" value={city} onChange={e => setCity(e.target.value)} className="pl-10 bg-white/90 border-white/30 h-11 xs:h-12 rounded-xl text-sm xs:text-base" />
                </div>
              </div>

              <div className="sm:col-span-1">
                <div className="relative">
                  <Input placeholder="Prix max (XOF)" type="number" value={maxPrice} onChange={e => setMaxPrice(e.target.value)} className="px-4 bg-white/90 border-white/30 h-11 xs:h-12 rounded-xl text-sm xs:text-base" />
                </div>
              </div>

               <div className="sm:col-span-2 lg:col-span-1">
                <Button onClick={handleSearch} className="w-full h-11 xs:h-12 bg-gradient-to-r from-accent via-accent to-secondary hover:shadow-glow-accent text-white shadow-elevated transition-smooth rounded-xl font-bold text-sm xs:text-base">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 xs:gap-5 md:gap-7 mt-10 xs:mt-14 w-full max-w-4xl mx-auto px-2">
            ...
            value: "50+",
            color: "primary"
          }].map((stat, index) => <div key={index} className="glass-effect-dark rounded-2xl p-4 xs:p-5 hover-lift text-center flex flex-col items-center justify-center border-2 border-white/10 hover:border-accent/50 transition-smooth group">
