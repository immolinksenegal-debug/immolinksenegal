      ...
      <div className="container mx-auto px-4 relative z-10 pt-24 pb-12">
        <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="mb-6 px-2">
            ...
            <h1 className="text-3xl xs:text-4xl md:text-6xl lg:text-7xl font-black leading-[1.15] tracking-tight bg-gradient-to-r from-primary-glow via-secondary to-primary-glow bg-clip-text text-transparent drop-shadow-[0_2px_12px_hsl(var(--background)/0.9)]">
              bien idéal
            </h1>
          </div>
