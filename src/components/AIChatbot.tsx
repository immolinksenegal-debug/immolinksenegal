...
const AIChatbot = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Bonjour ! 👋 Je suis votre assistant immobilier IA. Comment puis-je vous aider aujourd'hui ? Cherchez-vous à acheter, vendre ou simplement en savoir plus sur ImmoLink ?"
    }
  ]);
      ...
      if (!resp.ok) {
        if (resp.status === 429) {
          toast({
            ...
            description: "Trop de requêtes. Veuillez patienter un moment.",
            variant: "destructive",
          });
          return;
        }
    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-6 right-6 h-14 w-14 rounded-full shadow-lg hover:scale-110 transition-transform bg-primary z-50"
          size="icon"
        >
        ...
        <Card className="fixed inset-4 md:bottom-6 md:right-6 md:left-auto md:top-auto md:w-[400px] md:h-[600px] shadow-2xl flex flex-col z-50 animate-in slide-in-from-bottom-4">
          ...
          <div className="bg-primary text-white p-4 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-semibold">Assistant IA ImmoLink</h3>
