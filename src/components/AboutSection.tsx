...
const AboutSection = () => {
  ...
  return (
    <section className="py-20 md:py-28 relative overflow-hidden bg-transparent">
      ...
      <div className="absolute top-20 right-10 w-[400px] h-[400px] bg-primary/8 rounded-full blur-[130px] pointer-events-none"></div>
      <div className="absolute bottom-20 left-10 w-[400px] h-[400px] bg-secondary/8 rounded-full blur-[130px] pointer-events-none"></div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent/8 rounded-full blur-[150px] pointer-events-none"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6 mb-14">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  {/* Accent line */}
                  <div className={`absolute top-0 left-0 right-0 h-1 bg-${feature.color} scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500`} />

                  <div className="relative flex items-start gap-5">
                    <div className={`relative w-16 h-16 rounded-2xl bg-${feature.color}/80 flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500`}>
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative z-10 text-center p-10 md:p-16">
              ...
              <Link to="/dashboard">
                <Button
                  size="lg"
                  className="bg-primary text-primary-foreground hover:opacity-90 rounded-2xl font-bold text-lg px-10 py-6 shadow-xl hover:shadow-[0_0_30px_hsl(var(--accent)/0.4)] transition-all duration-300 group"
                >
