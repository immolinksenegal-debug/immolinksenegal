                ...
                <CardContent className="px-3 xs:px-6">
                  {isLoading ? (
                          ...
                          <div className="absolute top-2 right-2 z-10 flex flex-wrap gap-2 max-w-[90%]">
                            ...
                            {!property.isPremium ? (
                              <Button
                                ...
                                className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-glow transition-smooth rounded-lg text-xs px-2 py-1"
                              >
                    ...
                    <div className="text-center py-8 xs:py-12">
                      ...
                      <Button 
                        onClick={() => setShowPropertyForm(true)}
                        className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-glow transition-smooth rounded-xl text-xs xs:text-sm px-3 xs:px-4 py-2"
                      >
                        <PlusCircle className="h-3 w-3 xs:h-4 xs:w-4 mr-1 xs:mr-2" />
                        Créer une annonce
                      </Button>
