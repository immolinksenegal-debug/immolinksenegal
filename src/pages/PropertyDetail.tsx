              ...
              <div className="glass-effect rounded-xl xs:rounded-2xl p-4 xs:p-6 shadow-card lg:sticky lg:top-24 animate-scale-in">
                ...
                <div className="space-y-3 xs:space-y-4 mb-4 xs:mb-6">
                  ...
                  {isOwner ? (
                    ...
                    <Button 
                      className="w-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-glow transition-smooth rounded-xl font-semibold h-10 xs:h-12 text-sm xs:text-base"
