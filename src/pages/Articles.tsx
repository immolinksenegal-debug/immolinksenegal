  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        {/* Hero Banner */}
        <PageBanner
          image={bannerFiscalite}
          alt="Bureau moderne avec journaux et graphiques du marché immobilier sénégalais, actualités Immo Link Sénégal"
          title="Actualités Immobilières"
          subtitle="Restez informé des dernières tendances du marché immobilier sénégalais"
          focal="50% 45%"
          focalMobile="50% 35%"
          eager
        />
